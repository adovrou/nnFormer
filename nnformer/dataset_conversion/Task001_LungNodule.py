...
def create_split_json(path_base: Path):
    ...
    train_mapping_path = Path("/home/kdovrou/PhD/Data/train_nnFormer_mapping.csv")
    val_mapping_path = Path("/home/kdovrou/PhD/Data/val_nnFormer_mapping.csv")
...
if __name__ == "__main__":
    ...
    path_dataset = path_base.joinpath('models/DATASET/nnFormer_raw/nnFormer_raw_data/Task001_LungNodule')
    ...
    path_labelsTs = path_dataset.joinpath('labelsTs')
    path_labelsTs.mkdir(exist_ok=True, parents=True)
