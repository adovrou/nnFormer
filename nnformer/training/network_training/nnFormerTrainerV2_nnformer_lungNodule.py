...
from nnformer.network_architecture.nnFormer_tumor import nnFormer # I keep nnFormer_tumor for network architecture since my images are isotropic lung nodules.
...
class nnFormerTrainerV2_nnformer_lungNodule(nnFormerTrainer):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.load_pretrain_weight=False # disable loading pretrain weight checkpoint since I do not have it
